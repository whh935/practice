 ...
 * Desc: 滑动窗口最大值-https://leetcode-cn.com/problems/sliding-window-maximum/
...
$k = 3;
var_dump($solution->maxSlidingWindow1($nums, $k));
var_dump($solution->maxSlidingWindow2($nums, $k));
